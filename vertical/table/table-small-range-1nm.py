...
policy1.load_state_dict(torch.load('C:/Users/coty/Documents/RL-balance-robot/vertical/training-1nm/outputs/PPO_vertical_0_1NM-3.pth'))
policy1.to(device)
    ...
    for j in range(N2):
        for k in range(N3):
            ...
            for step in range(steps):
                ...
                if abs(y[0] - thtb_target) < settle_tb and abs(y[1] - dthtb_target) < settle_dtb * 50 and abs(y[2] - dthtb_target) < settle_dtw * 200:
                    flag += 1
