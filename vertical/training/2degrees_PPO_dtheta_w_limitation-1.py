...
class PendulumEnv:
    ...
    def step(self, act_index):
        ...
        self.steps += 1
        if abs(self.state[0] - thtb_target) < settle and abs(self.state[1] - dthtb_target) < settle * 10 and abs(self.state[2] - dthtb_target) < settle * 70:
